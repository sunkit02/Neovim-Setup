...
vim.keymap.set("n", "<C-w>v", "<C-w>v<C-w>l",
  { noremap = true, silent = true, desc = "Jump to new vertical split window after opening it" })
vim.keymap.set("n", "<C-w>s", "<C-w>s<C-w>j",
  { noremap = true, silent = true, desc = "Jump to new horizontal split window after opening it" })
...
vim.keymap.set("t", "<leader><Left>", "<C-\\><C-N><cmd>tabp<CR>",
  { silent = true, desc = "Move one tab to the left in terminal mode" })
vim.keymap.set("t", "<leader><Right>", "<C-\\><C-N><cmd>tabn<CR>",
  { silent = true, desc = "Move one tab to the right in terminal mode" })
vim.keymap.set("n", "<leader>t", "<C-\\><C-N>:tabnew ",
  { noremap = true, silent = true, desc = "Start typing name of file to open in new tab" })

-- Resize window with arrows
vim.keymap.set("n", "<C-Up>", "<cmd>resize +2<CR>",
  { noremap = true, silent = true, desc = "Increase current window height" })
vim.keymap.set("n", "<C-Down>", "<cmd>resize -2<CR>",
  { noremap = true, silent = true, desc = "Decrease current window height" })
vim.keymap.set("n", "<C-Left>", "<cmd>vertical resize -2<CR>",
  { noremap = true, silent = true, desc = "Decrease current window width" })
vim.keymap.set("n", "<C-Right>", "<cmd>vertical resize +2<CR>",
  { noremap = true, silent = true, desc = "Increase current window width" })
...
vim.keymap.set("v", "J", ":m '>+1<CR>gv=gv",
  { noremap = true, silent = true, desc = "Move highlighted line up one line" })
...
vim.keymap.set("n", "<C-u>", "<C-u>zz",
  { noremap = true, silent = true, desc = "Keep cursor centered after moving half a page up" })
vim.keymap.set("n", "n", "nzzzv",
  { noremap = true, silent = true, desc = "Keep cursor centered after jumping to the next matching regex search" })
vim.keymap.set("n", "N", "Nzzzv",
  { noremap = true, silent = true, desc = "Keep cursor centered after jumping to the previous matching regex search" })

-- Keeping origin buffer content after pasting over
vim.keymap.set("x", "<leader>p", "\"_dP",
  { noremap = true, silent = true, desc = "Keep original buffer content after pasting over highlighted text" })

-- Seperating vim clipboard and system clipboard
vim.keymap.set("n", "<leader>y", "\"+y",
  { noremap = true, silent = true, desc = "Yank to system clipboard in normal mode" })
vim.keymap.set("v", "<leader>y", "\"+y",
  { noremap = true, silent = true, desc = "Yank to system clipboard in visual mode" })
vim.keymap.set("n", "<leader>Y", "\"+Y", { noremap = true, silent = true, desc = "Yank entire line to system clipboard" })
vim.keymap.set("n", "<leader>P", "\"+p",
  { noremap = true, silent = true, desc = "Paste from system clipboard in normal mode" })
vim.keymap.set("v", "<leader>P", "\"+p",
  { noremap = true, silent = true, desc = "Paste from system clipboard in visual mode" })
...
vim.keymap.set("n", "<C-n>", "<cmd>cnext<CR>zz",
  { noremap = true, silent = true, desc = "Next item on quickfix list and center cursor" })
vim.keymap.set("n", "<C-m>", "<cmd>cprev<CR>zz",
  { noremap = true, silent = true, desc = "Previous item on quickfix list and center cursor" })
vim.keymap.set("n", "<leader>j", "<cmd>lnext<CR>zz",
  { noremap = true, silent = true, desc = "Next item in current buffer and center cursor" })
vim.keymap.set("n", "<leader>k", "<cmd>lprev<CR>zz",
  { noremap = true, silent = true, desc = "Previous item in current buffer and center cursor" })
vim.keymap.set("n", "<C-q>", "<cmd>lua ToggleQuickFixList()<CR>",
  { noremap = true, silent = true, desc = "Previous item in current buffer and center cursor" })
